...
--> statement-breakpoint
ALTER TABLE "ad_accounts" ADD COLUMN "project_id" uuid;--> statement-breakpoint
ALTER TABLE "ig_accounts" ADD COLUMN "project_id" uuid;--> statement-breakpoint
...
ALTER TABLE "ad_accounts" ADD CONSTRAINT "ad_accounts_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ig_accounts" ADD CONSTRAINT "ig_accounts_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ad_accounts_project_idx" ON "ad_accounts" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "ig_accounts_project_idx" ON "ig_accounts" USING btree ("project_id");--> statement-breakpoint
